...
static struct map_desc uart_io_desc __initdata = {
	//.virtual        = 0xfec02000,
	.virtual        = SOCFGA_UART0_VIRT_BASE,	//yejc
...
//yejc
static void __init socfpga_bm_reserve(void)
{
        printk("reserve 32MB@0x%08x for Bare Metel\n", BM_MEM_START);
        /* untouch uC/OS-II memoery */
        memblock_free(BM_MEM_START, 32*SZ_1M);
        memblock_remove(BM_MEM_START, 32*SZ_1M);
}
