			   ...
			   u32 percpu_offset, struct device_node *node)
{
	...
	irq_base = irq_alloc_descs(irq_start, 0, gic_irqs, numa_node_id()); //yejc
	...
	asp = (struct amp_share_param *)AMP_SHARE_PARAM_START; //yejc
	if(asp->bm_magic != (('b'<<8) + 'm'))
		gic_dist_init(gic);
	else
