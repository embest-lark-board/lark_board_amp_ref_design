...
* note: 2013.01.01 must modify here, becuase void __weak board_init_f(ulong dummy) in the
* arch/arm/lib/spl.c, it has __weak attribute, the real code called is at here.
*/
...
!defined(CONFIG_SPL_NAND_SUPPORT) && !defined(CONFIG_SPL_SPI_SUPPORT)
	...
	*((volatile u32*)0x5000000) = gd;//xuewt add
