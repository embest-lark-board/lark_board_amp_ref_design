...
/*because the thumb doesnot support mrc, so disable it*/
...
***************************************************************************
*
* if you want to debug the sd load function in the bare metal, you can define it.
*/
#undef CONFIG_DEBUG_BM_SD_LOAD_RBF
